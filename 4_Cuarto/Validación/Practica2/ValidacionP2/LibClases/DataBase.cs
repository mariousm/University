...
namespace LibClases
{
    public class DataBase
    {
        ...
        public DataBase()
        {
            ...
            encuestas.Add(e2);
            **/
            using (var reader = new StreamReader(@"C:\Users\mario\Desktop\13173430L-71300921R\ValidacionP2\Ficheros\Usuarios.csv"))
            {
            ...
            using (var reader = new StreamReader(@"C:\Users\mario\Desktop\13173430L-71300921R\ValidacionP2\Ficheros\Encuestas.csv"))
            {
                while (!reader.EndOfStream)
                {
                    var line = reader.ReadLine();
            ...
            using (var reader = new StreamReader(@"C:\Users\mario\Desktop\13173430L-71300921R\ValidacionP2\Ficheros\Valoraciones.csv"))
            {
                while (!reader.EndOfStream)
                {
                    var line = reader.ReadLine();
