...
def configuraPoblacion(toolbox):
	...
	toolbox.register("attribute", random.randint,1, dv.punto_fin[0]-1)
	#toolbox.register("attribute", generarGenotipoValido, 0.9) 
	''' El individuo se crea como una lista (o repeticion) de "attribute", definido justo antes
	Tendrá una longitud de 5 atributos '''
	toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attribute, dv.punto_fin[0])
...
def generarGenotipoValido(probabilidad):
	...
	if aleatorio < probabilidad:
		return 1
	return random.randint(1,dv.punto_fin[0]-1)
