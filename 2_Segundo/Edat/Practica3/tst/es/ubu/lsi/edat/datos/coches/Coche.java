...
public class Coche {
	...
	/**
	 * @return devuelve una cadena de texto representando el contenido del
	 *         objeto
	 */
	...
	/**
	 * @param caballos
	 *            numero de caballos a almacenar.
	 */
	...
	/**
	 * @param modelo
	 *            que se desea establecer en el coche.
	 */
	...
	/**
	 * Para comprobar si dos coches son iguales, deberán ser iguales: la marca,
	 * el modelo y el numero de caballos.
	 */
	@Override
