...
import es.ubu.lsi.edat.pr10.ArbolBB.Nodo;

/**
 * Clase que implementa el interfaz java.util.Set empleando para ello la
 * estructura de un árbol binario de búsqueda
 * 
 * @author bbaruque
 *
 * @param <E>
 *            Parametro de genericiadad de la estructura
 */
...
public class ArbolBB<E> extends AbstractSet<E> {
	...
	public class Nodo {
		 ...
		 * 
		 * @param dato
		 *            dato El dato que contendra el nodo
		 */
		public Nodo(E dato) {
			this.dato = dato;
		}
		 ...
		 * 
		 * @param valor
		 *            El nuevo subarbol izquierdo de ese nodo
		 */
		 ...
		 * 
		 * @param valor
		 *            El nuevo subarbol derecho de ese nodo
		 * 
		 */
	 ...
	 * La raiz del arbol
	 */
	protected Nodo raiz = null; // Un arbol está definido por una referencia a
								// un nodo
	...
	/**
	 * Referencia al comparador empleado para organizar los elementos en el
	 ...
	 * 
	 * @param coleccion
	 *            que se incluye en el set en el momento de su instanciacion No
	 *            se incluiran los elementos duplicados
	 */
	 ...
	 *            se incluiran los elementos duplicados
	 * @param c
	 *            comparador empleado para determinar el orden de los elementos
	 *            en el Set
	 */
	 ...
	 * que se solicita localizar en el árbol. Permite facilitar el punto de
	 * partida desde el que se va a proceder a buscar. No es obligatorio que se
	 * trate de la raiz de todo el arbol.
	 * 
	 * La lista que devuelve contiene dos referencias a nodos: el primero es el
	 * nodo que contiene el dato buscado y (null si el dato no esta en el arbol)
	 * el segundo corresponde al nodo del que cuelga (null si es la raiz).
	 * 
	 * @param raiz
	 *            del subarbol sobre el que se va a buscar
	 * @param buscado
	 *            dato que se ppretende localizar
	 ...
	 * 
	 * @param inicio
	 *            punto desde el que se va a proceder a buscar
	...
	/**
	 * Metodo auxiliar que permite enlazar un nuevo nodo en el arbol. El nuevo
	 * nodo colgará de aquel que se pasa como parametro y tendrá como
	 * contenido el dato facilitado
	 * 
	 * @param encontrado
	 *            lista que contiene el nodo sobre el que colgará el nuevo
	 * @param datoInsertar
	 *            dato que contendrá el nuevo nodo
	 * @return
	 */
	...
	protected Nodo insertar(Nodo padre, E datoInsertar) {
		...
		else if (comparar(datoInsertar, padre.getDato()) > 0) // Si el padre es
																// menor
	...
	/**
	 * Metodo auxiliar que permite desenlazar un nodo ya contenido en el arbol,
	 * respetando que el resto de nodos ya incluidos sigan conformando un árbol
	 * binario de búsqueda.
	 * 
	 * @param raiz
	 *            Nodo que se va a eliminar del arbol.
	 * @param padre
	 *            Nodo al que está enlazado el nodo a eliminar
	 * @param datoBorrar
	 *            dato que se pretende eliminar del arbol
	 * @return true en caso de que se haya procedido a eliminarlo y false en
	 *         caso contrario
	 */
	protected boolean eliminar(Nodo raiz, Nodo padre, E datoBorrar) {
		...
		// Si el paso anterior fue el intercambio, no se encontrará el padre
		// correctamente
		...
		if (!tieneIzq && !tieneDer) {
			...
			// Si tiene 2 hijos, se sustituye por el menor de la derecha o por
	...
	/**
	 * Metodo que permite obtener el listado ordenado de datos contenidos en el
	 * Set. Permite obtener un subconjunto del mismo, al admitir en la raiz el
	 * punto en el que se comienza a recuperar datos.
	 * 
	 * Se emplea como metodo auxiliar para realizar el iterador Resulta poco
	 * eficiente, pero se emplea como muestra.
	 * 
	 * @param actual
	 *            nodo a partir del que se realiza el recorrido del subarbol
	 * @param listaRecorridos
	 *            recorrido en forma de lista (ordenado)
	 */
